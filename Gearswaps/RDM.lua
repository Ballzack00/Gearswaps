...
include('Rnic-Items.lua')
	...
	-- FC: +51 DT: 50%
		...
		back=rdm_fc_jse_back, --Put DT -5 on this cape
		waist="Witful Belt",
		legs="Aya. Cosciales +2",
		feet=merlinic_dt_feet}
    ...
    sets.precast.WS['Chant du Cygne'] = set_combine(sets.precast.WS, {
        ammo="Yetshila +1",
		head="Jhakri Coronal +2", -- Malignance Chapeau
		ear1="Mache Earring +1",
		ear2="Mache Earring +1",
		body="Ayanmo Corazza +2",
		hands="Jhakri Cuffs +2", -- Malignance Gloves
		ring1="Begrudging Ring",
		ring2="Ilabrat Ring",
		back=rdm_crit_jse_back,
		legs="Viti. Tights +3",
    ...
    sets.precast.WS['Savage Blade'] = set_combine(sets.precast.WS, {
		...
		back=rdm_wsd_jse_back,
		waist="Prosilio Belt +1",
		legs="Jhakri Slops +2",
		feet=chironic_ws_feet}) --mnd/str/wsd
    ...
    sets.midcast.Cure = {
        main="Tamaxchi", -- Daybreak
        sub="Ammurapi Shield",
        ammo="Regal Gem",
        head="Kaykaus Mitra +1",
		neck="Incanter's Torque",
        ear1="Healing Earring", -- Meili Earring
		ear2="Beatific Earring",
        body="Kaykaus Bliaut +1",
        hands="Kaykaus Cuffs +1",
		ring1="Menelaus's Ring", -- Janniston Ring
        ring2={name="Stikini Ring +1", bag="wardrobe4"}, -- Sirona Ring
        back=rdm_mnd_jse_back,
        waist="Luminary Sash",
    ...
    sets.midcast.Curaga = set_combine(sets.midcast.Cure, {ring1={name="Stikini Ring +1", bag="wardrobe3"}})

    sets.midcast.StatusRemoval = sets.precast.FC

    sets.midcast.Cursna = set_combine(sets.midcast.StatusRemoval, {
		head=vanya_cure_head,
        neck="Debilis Medallion",
        ear1="Beatific Earring",
		ear2="Healing Earring", -- Meili Earring
		body="Viti. Tabard +3",
    ...
    sets.midcast['Enhancing Magic'] = {
        ...
        head="Befouled Crown",
		neck="Incanter's Torque",
        ear1="Augment. Earring", -- Mimir Earring
        ear2="Andoaa Earring",
        body="Viti. Tabard +3",
        hands="Viti. Gloves +3",
		ring1={name="Stikini Ring +1", bag="wardrobe3"},
        ring2={name="Stikini Ring +1", bag="wardrobe4"},
        back=rdm_enhancing_jse_back,
        waist="Olympus Sash",
    ...
    sets.midcast['Phalanx'] = set_combine(sets.midcast.EnhancingDuration, {feet=merlinic_phalanx_feet})
    ...
    sets.midcast.MndEnfeebles = {
		...
		ammo="Regal Gem",
		head="Viti. Chapeau +3",
		neck="Dls. Torque +2", -- Dls. Torque +2
		ear1="Gwati Earring", -- Regal Earring
		ear2="Digni. Earring", -- Snotra Earring
    ...
    sets.midcast.SkillEnfeebles = set_combine(sets.midcast.MndEnfeebles, {
		...
		head="Viti. Chapeau +3",
		neck="Incanter's Torque",
		ear1="Regal Earring", -- Vor Earring
    ...
    sets.midcast.EffectEnfeebles = set_combine(sets.midcast.MndEnfeebles, {
        main="Mafic Cudgel", -- Daybreak
		sub="Sacro Bulwark",
		ammo="Regal Gem",
		head="Viti. Chapeau +3",
		neck="Dls. Torque +2", -- Dls. Torque +2
		ear1="Etiolation Earring",
		ear2="Genmei Earring", -- Snotra Earring
		body="Lethargy Sayon +1",
		hands="Regal Cuffs",
		ring1="Kishar Ring",
		ring2="Defending Ring",
		back=rdm_mnd_jse_back,
		waist="Flume Belt +1",
		legs="Viti. Tights +3", -- Malignance Tights
		feet="Vitiation Boots +3"})
    ...
    sets.midcast['Elemental Magic'] = {
		...
		sub="Ammurapi Shield",
		ammo="Pemphredo Tathlum",
		head=merlinic_burst_head, -- C. Palug Crown
		neck="Sanctity Necklace", -- Baetyl Pendant
		ear1="Digni. Earring", -- Regal Earring
		ear2="Friomisi Earring", -- Malignance Earring
		body="Amalric Doublet +1",
    ...
    sets.midcast.Impact = set_combine(sets.midcast['Elemental Magic'], {
		...
		head=empty,
		neck="Dls. Torque +2", -- Dls. Torque +2
		ear1="Regal Earring", -- Snotra Earring
		ear2="Digni. Earring", -- Malignance Earring
		body="Twilight Cloak",
		hands="Regal Cuffs",
		ring1={name="Stikini Ring +1", bag="wardrobe3"},
		ring2={name="Stikini Ring +1", bag="wardrobe4"},
    ...
    sets.idle = {
		...
		ear2="Sanare Earring",
        body="Jhakri Robe +2",
        hands=merlinic_refresh_hands,
        ring1={name="Stikini Ring +1", bag="wardrobe3"},
        ring2={name="Stikini Ring +1", bag="wardrobe4"},
        back="Moonlight Cape",
		waist="Slipor Sash",
		legs="Carmine Cuisses +1",
		feet=merlinic_refresh_feet}

    sets.idle.DT = set_combine(sets.idle, {
		head=merlinic_dt_head,
        body="Ayanmo Corazza +2",
		hands="Aya. Manopolas +2",
        ring1="Vocane Ring",
        ring2="Defending Ring",
    ...
    sets.engaged = {
        ...
        ear2="Sherida Earring",
        body="Ayanmo Corazza +2",
        hands=taeon_ta_hands,
		ring1="Hetairoi Ring",
        ring2="Chirich Ring +1",
        back=rdm_stp_jse_back,
